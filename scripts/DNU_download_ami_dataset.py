...
def download_and_process_ami():
    ...
    # Create raw directory if it doesn't exist (assuming this is still needed)
    os.makedirs("data/meeting_recordings/raw", exist_ok=True) 
    # os.makedirs("data/meeting_recordings/demo", exist_ok=True) # Demo directory removed
    ...
    # Commenting out the processing and saving related to the deleted 'demo' directory
    ...
    #     # Define business_audio_path even if saving fails, for potential fallback use (though unlikely needed now)
    #     business_audio_path = "data/meeting_recordings/demo/business-meeting-1.wav" 
    ...
    #         # Check existence using the defined variable
    #         if os.path.exists(business_audio_path):
    #             # Ensure the target directory exists before copying
    #             # os.makedirs(os.path.dirname("data/meeting_recordings/demo/team-discussion-1.wav"), exist_ok=True)
    ...
    print("AMI dataset download finished (processing/saving to demo directory skipped).")
